package com.iiex.lab07_5;

import com.iiex.lab07_5.entity.Student;
import com.iiex.lab07_5.Repository.StudentRepository;
...
public class Lab07_5 implements CommandLineRunner {
    ...
    public static void main(String[] args) {
        SpringApplication.run(Lab07_5.class, args);
    }
    ...
    public  void run(String... args) throws Exception {
        ...
        studentRepository.findByNameEquals("Jo").forEach(System.out::println);
    }
}
