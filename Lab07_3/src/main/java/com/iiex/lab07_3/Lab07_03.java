package com.iiex.lab07_3;

import com.iiex.lab07_3.entity.Student;
import com.iiex.lab07_3.respository.StudentRepository;
import org.springframework.boot.CommandLineRunner;
import org.springframework.boot.SpringApplication;
import org.springframework.boot.autoconfigure.SpringBootApplication;

@SpringBootApplication
public class Lab07_03 implements CommandLineRunner {

    private final StudentRepository studentRepository;

    public Lab07_03(StudentRepository studentRepository) {
        this.studentRepository = studentRepository;
    }

    public static void main(String[] args) {
        SpringApplication.run(Lab07_03.class, args);
    }
    ...
    public  void run(String... args) throws Exception {
        ...
        studentToUpdate.setName("Thanh Qui");
